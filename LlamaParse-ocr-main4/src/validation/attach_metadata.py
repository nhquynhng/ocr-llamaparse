...
def gan_metadata_vao_file_llama(
    output_path: str | Path,
    source_file: str | Path,
    cau_hinh: Any,
    document_type: str | None = None,
    ...
    """
    Đọc file Markdown đã ghi, gắn YAML metadata + validation,
    rồi ghi đè lại chính file đó.
    """

    out = Path(output_path)
    markdown = out.read_text(encoding="utf-8")

    markdown = gan_metadata_vao_markdown_llama(
        markdown=markdown,
        output_path=out,
        source_file=source_file,
        cau_hinh=cau_hinh,
